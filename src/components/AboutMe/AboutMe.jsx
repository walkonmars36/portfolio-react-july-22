      ...
      <div className="about-me__content">
        ...
        <div className="about-me__text">
          ...
          <p>
            ...
            I&#39;d never been happier than when working on websites. So, since March 2020 I have become more engrossed in web development, studying through online courses and also a 12 week full stack bootcamp run by{" "}
            <a className="about-me__nology" href="https://nology.io/" target="_blank" rel="noreferrer">
              _nology
            </a>{" "}
            which ran from May - July 2022.
          </p>

          <p>Since completing the bootcamp I have been practising and expanding my knowledge of CSS, JavaScript and React and also learnt some basic Python and Django to expand my knowledge of backend development.</p>
...
/* 
I have been very interested in web development for a long time and am currently leveling up to be able to work successfully with the latest web technologies and frameworks. 
*/
